...
var supabaseApiHeaders = /* @__PURE__ */ __name((apiKey, bearerToken) => ({
  apikey: apiKey,
  "Content-Type": "application/json",
...
// lingoleaf/api/admin-analytics.ts
...
var firstNonEmptyString = /* @__PURE__ */ __name((...values) => {
...
var parseIsoDate = /* @__PURE__ */ __name((value) => {
  if (!value) {
    return null;
  }
...
var normalizeRecentEvent = /* @__PURE__ */ __name((value) => {
...
var supabaseRpc = /* @__PURE__ */ __name(async ({
  url,
  anonKey,
  token,
  rpcName,
...
// lingoleaf/api/contact.ts
var onRequestPost3 = /* @__PURE__ */ __name(async (context) => {
  const { request, env } = context;
  const apiKey = env.RESEND_API_KEY;
  const json4 = /* @__PURE__ */ __name((data, status = 200) => new Response(JSON.stringify(data), {
    status,
    headers: {
      "Content-Type": "application/json",
      "Cache-Control": "no-store"
  ...
  try {
    ...
    const readField = /* @__PURE__ */ __name((key) => {
...
// lingoleaf/api/turnstile-verify.ts
...
var onRequestOptions3 = /* @__PURE__ */ __name(async () => new Response(null, {
  status: 204,
  headers: {
    "Access-Control-Allow-Origin": "*",
    "Access-Control-Allow-Methods": "POST, OPTIONS",
...
// lingoleaf/[[path]].ts
var SPA_SHELL_PATH = "/lingoleaf-spa.html";
...
// ../.wrangler/tmp/pages-UG5LDa/functionsRoutes-0.5769337149741731.mjs
var routes = [
  {
...
// ../../../../../../../private/var/folders/xb/9rzdt3lx26q7kbj2zlh127yw0000gn/T/cursor-sandbox-cache/9f708bd9cb33649a45060e3814ea6417/npm/_npx/c943b712072b77c4/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../../../../private/var/folders/xb/9rzdt3lx26q7kbj2zlh127yw0000gn/T/cursor-sandbox-cache/9f708bd9cb33649a45060e3814ea6417/npm/_npx/c943b712072b77c4/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-aY1sTh/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-aY1sTh/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.701411458530357.mjs.map
